...
<form action="" method="post">
    ...
    <br>
    <br>
    <input type="text" name="iban2" pattern="<?php echo SepaUtilities::HTML_PATTERN_IBAN; ?>" placeholder="IBAN"><br>
    <input type="text" name="bic2" pattern="<?php echo SepaUtilities::HTML_PATTERN_BIC; ?>" placeholder="BIC"><br>
