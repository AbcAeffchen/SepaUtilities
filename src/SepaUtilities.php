...
class SepaUtilities
{
    ...
    public static function checkRequiredCollectionKeys(array $inputs, int $version): bool
    {
        switch($version)    // fall-through's are on purpose
        {
            case self::SEPA_PAIN_001_002_03:
                ...
                break;
            case self::SEPA_PAIN_001_001_09:
            ...
            case self::SEPA_PAIN_008_002_02:
                ...
                break;
            case self::SEPA_PAIN_008_001_08:
     ...
     * be removed as long as they cannot be converted. See
    ...
    private
    static function checkText(string $str, int $length): string|bool
    {
        return (self::checkLength($str, $length) && self::checkCharset($str)) ? $str : false;
    }
     ...
     *                                 can use both '.' and ',' as decimal point and thousands separator, but not the
     *                                 same symbole for both. So `1234.56`, `1,234.56`, `1.234,56`, `1234,56` are all
     *                                 valid inputs.
     * @return float|false
     */
